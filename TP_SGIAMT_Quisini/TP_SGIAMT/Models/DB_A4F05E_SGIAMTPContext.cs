...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TPuntaje>(entity =>
            {
                ...
                entity.Property(e => e.PkIpCodP)
                    .HasColumnName("PK_IP_CodP")
                    .ValueGeneratedNever();
            ...
            modelBuilder.Entity<TUsuarioModalidad>(entity =>
            {
                ...
                entity.Property(e => e.IumFase).HasColumnName("IUM_Fase");
                ...
                entity.HasOne(d => d.FkIcIdConcurso1)
                    .WithMany(p => p.TUsuarioModalidadFkIcIdConcurso1)
                    .HasForeignKey(d => d.FkIcIdConcurso)
                ...
                entity.HasOne(d => d.FkIuDniParejaNavigation)
                    ...
                    .HasConstraintName("FK_T_Usuario_Modalidad_T_Usuario1");
            });
