...
namespace TP_SGIAMT.Controllers
{
    public class TModalidadConsController : Controller
    {
        ...
        {
            ViewData["PkImIdModalidad"] = new SelectList(_context.TModalidadCon, "PkImIdModalidad", "VmNombreMod");
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tModalidadCon = await _context.TModalidadCon
                .FirstOrDefaultAsync(m => m.PkImIdModalidad == id);
        ...
        public async Task<IActionResult> Create([Bind("PkImIdModalidad,VmNombreMod")] TModalidadCon tModalidadCon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PkImIdModalidad,VmNombreMod")] TModalidadCon tModalidadCon)
        {
            if (id != tModalidadCon.PkImIdModalidad)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!TModalidadConExists(tModalidadCon.PkImIdModalidad))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.TModalidadCon.Any(e => e.PkImIdModalidad == id);
        }
    }
}
